...
exports.CapturePieceUseCase = void 0;
...
class CapturePieceUseCase {
    ...
    execute({ from, gameId, to }) {
        ...
        if (!gameRoom) {
            websocket_chess_package_1.logger.error(`CapturePieceUseCase: GameRoom not found`);
        ...
        try {
            this.orchestrator.capture(gameId, playerId, new position_1.Position(from.x, from.y), new position_1.Position(to.x, to.y));
...
exports.CapturePieceUseCase = CapturePieceUseCase;
